  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final buttonWidth = isMobile ? 80.w : 98.0;
...
class _BanquetDetailsAction extends StatelessWidget {
  final VoidCallback onTap;

  const _BanquetDetailsAction({required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    final gap = isMobile
        ...
        ? 7.0
        : 6.0;
    final textSize = isTablet ? 15.0 : 13.0;
