class ReservationCancelledModel {
  final int id;
  final String uuid;
  ...
  factory ReservationCancelledModel.fromJson(Map<String, dynamic> json) {
    return ReservationCancelledModel(
      id: _toInt(json['id']),
...
class ReservationCancelledModelResponse {
  final bool status;
  final List<ReservationCancelledModel> reservations;

  ReservationCancelledModelResponse({
    required this.status,
    required this.reservations,
  });

  factory ReservationCancelledModelResponse.fromJson(
    ...
    return ReservationCancelledModelResponse(
      ...
      reservations: reservationsList
          .whereType<Map>()
          .map((item) => ReservationCancelledModel.fromJson(Map<String, dynamic>.from(item)))
          .toList(),
    );
  }
}