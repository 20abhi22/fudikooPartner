class ReservationProcessingModel {
  final int id;
  final String uuid;
  ...
  factory ReservationProcessingModel.fromJson(Map<String, dynamic> json) {
    return ReservationProcessingModel(
      id: _toInt(json['id']),
...
class ReservationProcessingModelResponse {
  final bool status;
  final List<ReservationProcessingModel> reservations;

  ReservationProcessingModelResponse({
    required this.status,
    required this.reservations,
  });

  factory ReservationProcessingModelResponse.fromJson(Map<String, dynamic> json) {
    ...
    return ReservationProcessingModelResponse(
      ...
      reservations: reservationsList
          .whereType<Map>()
          .map((item) => ReservationProcessingModel.fromJson(Map<String, dynamic>.from(item)))
          .toList(),
    );
  }
}
